...
details = {
    "name" : "https://details.k8sdemo.powerupcloud.com{0}:443".format(servicesDomain),
    "endpoint" : "details",
    "children" : []
}

ratings = {
    "name" : "https://ratings.k8sdemo.powerupcloud.com{0}:443".format(servicesDomain),
    "endpoint" : "ratings",
    "children" : []
}

reviews = {
    "name" : "https://reviews.k8sdemo.powerupcloud.com{0}:443".format(servicesDomain),
    "endpoint" : "reviews",
    "children" : [ratings]
}
